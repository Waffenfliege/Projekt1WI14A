...
public class EmpiricDistributionPanel extends JPanel{
	...
	public EmpiricDistributionPanel(ArrayList<Rectangle> rectangles, ArrayList<Vector2D>positions, Vector2D origin, Color borderColor, int width, int height, int chartWidth, int chartHeight){
		super();
